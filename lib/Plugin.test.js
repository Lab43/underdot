...
describe('Plugin class', () => {
  ...
  it('accepts nextPlugin and queue arguments', () => {
  ...
  it('exports is an object of methods', () => {
  ...
  describe('exports.registerFileHandler', () => {
    ...
    it('wraps the handler and assigns it to this.nextFileHandler', async () => {
    ...
    it('only calls the handler for a file if it matches the rule', async () => {
    ...
    it('calls next handler even if the rule for this handler doesn\'t match', async () => {
      await plugin.nextFileHandler({path: kantPath, file: kantBuffer});
      expect(mockPlugin.nextFileHandler).toHaveBeenCalled();
    });

    it('calls the next hander multiple times if this handler returns an array', async () => {
  ...
  describe('exports.registerTreeHandler', () => {
    ...
    it('wraps the handler and assigns it to this.nextTreeHandler', async () => {
  ...
  describe('exports.enqueueFile', () => {
    it('enqueues a function which passes the file to the next plugin\'s file handler', async () => {
